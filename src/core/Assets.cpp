...
TextureRegion Assets::getInterfaceOverlayLeftBarTextureRegion()
{
    static TextureRegion textureRegion = TextureRegion(INTERFACE_OVERLAY_LEFT_BAR_TEXTURE_REGION_X, INTERFACE_OVERLAY_LEFT_BAR_TEXTURE_REGION_Y, INTERFACE_OVERLAY_LEFT_BAR_TEXTURE_REGION_WIDTH, INTERFACE_OVERLAY_LEFT_BAR_TEXTURE_REGION_HEIGHT, GAME_TEXTURE_WIDTH, GAME_TEXTURE_HEIGHT);
    return textureRegion;
}
...
TextureRegion Assets::getInterfaceOverlayBottomBarTextureRegion()
{
    static TextureRegion textureRegion = TextureRegion(INTERFACE_OVERLAY_BOTTOM_BAR_TEXTURE_REGION_X, INTERFACE_OVERLAY_BOTTOM_BAR_TEXTURE_REGION_Y, INTERFACE_OVERLAY_BOTTOM_BAR_TEXTURE_REGION_WIDTH, INTERFACE_OVERLAY_BOTTOM_BAR_TEXTURE_REGION_HEIGHT, GAME_TEXTURE_WIDTH, GAME_TEXTURE_HEIGHT);
    return textureRegion;
}

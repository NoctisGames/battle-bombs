...
TextureRegion Assets::getBombTextureRegion(BombGameObject &bomb)
{
    ...
    {
        bombTextureRegions.push_back(TextureRegion(BOMB_FRAME_TEXTURE_REGION_X, BOMB_FRAME_1_TEXTURE_REGION_Y, BOMB_TEXTURE_REGION_WIDTH, BOMB_TEXTURE_REGION_HEIGHT, GAME_TEXTURE_WIDTH, GAME_TEXTURE_HEIGHT));
        bombTextureRegions.push_back(TextureRegion(BOMB_FRAME_TEXTURE_REGION_X, BOMB_FRAME_2_TEXTURE_REGION_Y, BOMB_TEXTURE_REGION_WIDTH, BOMB_TEXTURE_REGION_HEIGHT, GAME_TEXTURE_WIDTH, GAME_TEXTURE_HEIGHT));
        bombTextureRegions.push_back(TextureRegion(BOMB_FRAME_TEXTURE_REGION_X, BOMB_FRAME_3_TEXTURE_REGION_Y, BOMB_TEXTURE_REGION_WIDTH, BOMB_TEXTURE_REGION_HEIGHT, GAME_TEXTURE_WIDTH, GAME_TEXTURE_HEIGHT));
        bombTextureRegions.push_back(TextureRegion(BOMB_FRAME_TEXTURE_REGION_X, BOMB_FRAME_4_TEXTURE_REGION_Y, BOMB_TEXTURE_REGION_WIDTH, BOMB_TEXTURE_REGION_HEIGHT, GAME_TEXTURE_WIDTH, GAME_TEXTURE_HEIGHT));
        bombTextureRegions.push_back(TextureRegion(BOMB_FRAME_TEXTURE_REGION_X, BOMB_FRAME_5_TEXTURE_REGION_Y, BOMB_TEXTURE_REGION_WIDTH, BOMB_TEXTURE_REGION_HEIGHT, GAME_TEXTURE_WIDTH, GAME_TEXTURE_HEIGHT));
        bombTextureRegions.push_back(TextureRegion(BOMB_FRAME_TEXTURE_REGION_X, BOMB_FRAME_6_TEXTURE_REGION_Y, BOMB_TEXTURE_REGION_WIDTH, BOMB_TEXTURE_REGION_HEIGHT, GAME_TEXTURE_WIDTH, GAME_TEXTURE_HEIGHT));
        bombTextureRegions.push_back(TextureRegion(BOMB_FRAME_TEXTURE_REGION_X, BOMB_FRAME_7_TEXTURE_REGION_Y, BOMB_TEXTURE_REGION_WIDTH, BOMB_TEXTURE_REGION_HEIGHT, GAME_TEXTURE_WIDTH, GAME_TEXTURE_HEIGHT));
    }
    
    static std::vector<TextureRegion> bombExplodingTextureRegions;
    if (bombExplodingTextureRegions.size() == 0)
    {
        bombExplodingTextureRegions.push_back(TextureRegion(BOMB_FRAME_TEXTURE_REGION_X, BOMB_EXPLOSION_FRAME_1_TEXTURE_REGION_Y, BOMB_TEXTURE_REGION_WIDTH, BOMB_TEXTURE_REGION_HEIGHT, GAME_TEXTURE_WIDTH, GAME_TEXTURE_HEIGHT));
        bombExplodingTextureRegions.push_back(TextureRegion(BOMB_FRAME_TEXTURE_REGION_X, BOMB_EXPLOSION_FRAME_2_TEXTURE_REGION_Y, BOMB_TEXTURE_REGION_WIDTH, BOMB_TEXTURE_REGION_HEIGHT, GAME_TEXTURE_WIDTH, GAME_TEXTURE_HEIGHT));
    }

...
#define INSIDE_BLOCK_TEXTURE_REGION_X 384
...
#define FREEZING_BREAKABLE_BLOCK_FRAME_TEXTURE_REGION_WIDTH 64
#define FREEZING_BREAKABLE_BLOCK_FRAME_TEXTURE_REGION_HEIGHT 64

...
#define GAME_STATE_WAITING_FOR_CONNECTION 1 // Only set when the GameScreen is first created
#define GAME_STATE_CONNECTION_ERROR_WAITING_FOR_INPUT 2
#define GAME_STATE_WAITING_FOR_SERVER 3
#define GAME_STATE_WAITING_FOR_LOCAL_SETTINGS 4
#define GAME_STATE_COUNTING_DOWN 5
#define GAME_STATE_SPECTATING 6
#define GAME_STATE_RUNNING 7
#define GAME_STATE_ENDING 8

...
- (NSString *)debugDescription {
    ...
    if([kvDictionaries count])
    {
        [ms appendString:@"POST DATA\n"];
    ...
    else if(_rawPOSTData)
    {
        ...
        NSString *postDataString = [[NSString alloc] initWithData:_rawPOSTData encoding:NSUTF8StringEncoding];
        
        [ms appendString:postDataString];
    }
...
- (void)startAsynchronous {
    ...
    BOOL showDebugDescription = YES;
    BOOL showCurlDescription = NO;

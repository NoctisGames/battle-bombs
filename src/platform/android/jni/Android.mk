...
LOCAL_SRC_FILES += $(CORE_FRAMEWORK_RELATIVE_PATH)/CircleBatcher.cpp
...
LOCAL_SRC_FILES += $(CORE_FRAMEWORK_RELATIVE_PATH)/Font.cpp
...
LOCAL_SRC_FILES += $(CORE_FRAMEWORK_RELATIVE_PATH)/LineBatcher.cpp
LOCAL_SRC_FILES += $(CORE_FRAMEWORK_RELATIVE_PATH)/OverlapTester.cpp
LOCAL_SRC_FILES += $(CORE_FRAMEWORK_RELATIVE_PATH)/Rectangle.cpp
LOCAL_SRC_FILES += $(CORE_FRAMEWORK_RELATIVE_PATH)/RectangleBatcher.cpp
LOCAL_SRC_FILES += $(CORE_FRAMEWORK_RELATIVE_PATH)/SpriteBatcher.cpp
LOCAL_SRC_FILES += $(CORE_FRAMEWORK_RELATIVE_PATH)/TextureRegion.cpp
LOCAL_SRC_FILES += $(CORE_FRAMEWORK_RELATIVE_PATH)/TouchEvent.cpp
...
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/ActiveButton.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/Assets.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/BombButton.cpp
...
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/CountDownNumberGameObject.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/Crater.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/DisplayGameOverGameObject.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/DisplayXMovingGameObject.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/DPadControl.cpp
...
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/InterfaceOverlay.cpp
...
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/PlayerAvatar.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/PlayerDynamicGameObject.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/PlayerRow.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/PlayerRowAvatar.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/PlayerRowPlatformAvatar.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/PowerUp.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/PowerUpBarItem.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/Renderer.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/SpaceTile.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/SpectatorControls.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/WaitingForLocalSettingsInterface.cpp
LOCAL_SRC_FILES += $(CORE_GAME_RELATIVE_PATH)/WaitingForServerInterface.cpp

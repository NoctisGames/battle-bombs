...
LOCAL_SRC_FILES += $(CORE_RELATIVE_PATH)/Crater.cpp
LOCAL_SRC_FILES += $(CORE_RELATIVE_PATH)/DisplayGameOverGameObject.cpp
LOCAL_SRC_FILES += $(CORE_RELATIVE_PATH)/DisplayXMovingGameObject.cpp
...
LOCAL_SRC_FILES += $(CORE_RELATIVE_PATH)/FallingObjectShadow.cpp
LOCAL_SRC_FILES += $(CORE_RELATIVE_PATH)/Fire.cpp
LOCAL_SRC_FILES += $(CORE_RELATIVE_PATH)/FireBall.cpp
...
LOCAL_SRC_FILES += $(CORE_RELATIVE_PATH)/IceBall.cpp
LOCAL_SRC_FILES += $(CORE_RELATIVE_PATH)/IcePatch.cpp
...
LOCAL_SRC_FILES += $(CORE_RELATIVE_PATH)/SpaceTile.cpp
